...
router.post('/set/global-variable', ResellerPromotionsController.setGlobalVariable);

router.put('/update/:id', ResellerPromotionsController.update);

router.delete('/delete/promotion/:promotionId', ResellerPromotionsController.delete);
