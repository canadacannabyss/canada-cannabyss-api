...
router.post('/set/global-variable', ResellerCategoriesController.setGlobalVariable);
...
router.delete('/delete/category/:categoryId', ResellerCategoriesController.delete);
