...
router.put('/update/shipping/handling', CustomerOrderController.updateShippingHandling);

router.put('/reset/shipping/handling', CustomerOrderController.resetShippingHandling);

router.put('/update/total/before-tax', CustomerOrderController.updateTotalBeforeTax);
...
router.put('/update/total/cryptocurrency', CustomerOrderController.updateTotalCryptocurrency);
...
router.post('/send/finished-order/start', CustomerOrderController.sendFinishedOrderStart);
