...
export async function updateStatusShipping(req: Request, res: Response) {
...
export async function updateStatusPaid(req: Request, res: Response) {
...
export async function sendTrackingNumberStart(req: Request, res: Response) {
